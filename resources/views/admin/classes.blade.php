...
@include('sweetalert::alert')
  <div class="sidebar active" id="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="{{ route('admin.classes')}}" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Classes</span>
      </div>
      ...
      <div class="addHallsContainer">
        <div class="main" role="main">
          <button class="popup-trigger btns" id="popup-trigger">
            <span>Add Class<i class="fa fa-plus-square-o"></i></span>
          </button>
        </div>
        <div class="overlay" id="overlay">
          ...
          <div class="overlay-content" id="overlay-content">
            ...
            <h1 class="main-heading">Add Lecturer</h1>
            <!-- <span class="blurb-tagline">and won't take longer than a couple of seconds.</span> -->
            <form class="hallsform signup-form" method="post" action="addClass">
              @csrf
              ...
              <input class="hallsInput" id="signup-name" type="number" min="1" max="4" name="year" autocomplete="off" maxlength="1" size="1" required/>
              <label class="hallsLabel" for="signup-name">No of Students</label>
              <input class="hallsInput" id="signup-name" type="number"  name="capacity" autocomplete="off" required/>
              ...
              <select id="status" name="department" required>
                <option>Select department</option>
                  ...
                  <option value="Environment Studies">Environmental Studies</option>
  ...
  <div class="row row--top-40">
    <div class="col-md-12">
      <h2 class="row__title">List of Classes (7)</h2>
    </div>
  </div>
        ...
        <table id="myTable" class="table">
          <thead class="table__thead">
            <tr class="t_head">
              ...
              <th class="table__th">No. of Students</th>
            ...
            <tr class="table-row table-row--chris">
              ...
              <td class="table-row__td">
                ...
                <div class="table-row__info">
                  <p class="table-row__name">{{ $class->name }}</p>
                  <span class="table-row__small"></span>
                </div>
              </td>
              <td data-column="Policy" class="table-row__td">
                <div class="">
                  <p class="table-row__policy">{{ $class->no_of_students }}</p>
                  <span class="table-row__small"></span>
                </div>                
              </td>
              <td data-column="Policy" class="table-row__td">
                <div class="">
                  <p class="table-row__policy">{{ $class->department }}</p>
                  <span class="table-row__small"></span>
                </div>                
              </td>
              ...
              <!-- <td  data-column="Status" class="table-row__td">
                <p class="table-row__status status">CE</p>
              </td> -->
              ...
              <td class="table-row__td" style="z-index: 100">
               <a href="editClass/{{ $class->id }}" onclick="javascript: return confirm('Are you sure you want to EDIT this record?');">
                ...
                <a href="deleteClass/{{ $class->id }}" onclick="javascript: return confirm('Are you sure you want to DELETE this record?');">
