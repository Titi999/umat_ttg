  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Edit Lecturer</span>
      </div>
    ...
    <div class="home-content">
      <div class="addHallsContainer">
          <div class="overlay-content" id="overlay-content">
            ...
            <form class="hallsform signup-form" action="{{ route('admin.editLect') }}" method="post">
              @csrf
              <input type="hidden" name="id" value="{{ $data['id'] }}">
              <label class="hallsLabel" for="signup-name">Title</label>
              <input value="{{ $data['title'] }}" class="hallsInput" id="signup-name" type="text" name="title" autocomplete="off" required/>
