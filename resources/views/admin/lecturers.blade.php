...
@include('sweetalert::alert')
  <div class="sidebar active" id="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="{{ route('admin.lecturers')}}" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Lecturers</span>
      </div>
      ...
      <div class="addHallsContainer">
        <div class="main" role="main">
          <button class="popup-trigger btns" id="popup-trigger">
            <span>Add Lecturer<i class="fa fa-plus-square-o"></i></span>
          </button>
        </div>
        <div class="overlay" id="overlay">
          ...
          <div class="overlay-content" id="overlay-content">
            ...
            <form class="hallsform signup-form" method="post" action="addLecturer">
              @csrf
              <label class="hallsLabel" for="title">Title</label>
              ...
              <label class="hallsLabel" for="signup-email">Status</label>
  ...
  <div class="row row--top-40">
    <div class="col-md-12">
      <h2 class="row__title">List of Lecturers (7)</h2>
    </div>
  </div>
            ...
            <tr class="table-row table-row--chris">
              ...
              <td class="table-row__td">
                ...
                <div class="table-row__info">
                  <p class="table-row__name">{{ $lecturer->title }} {{ $lecturer->name }}</p>
                  <span class="table-row__small"></span>
                </div>
              </td>
              <td data-column="Policy" class="table-row__td">
                <div class="">
                  <p class="table-row__policy">{{ $lecturer->department }}</p>
                  <span class="table-row__small"></span>
                </div>                
              </td>
              <td data-column="Policy status" class="table-row__td">
                <p class="table-row__p-status status {{ ($lecturer->status == 'Available') ? 'status--green' : 'status--red' }}">{{ $lecturer->status }}</p>
              </td>
              ...
              <td class="table-row__td" style="z-index: 100">
               <a href="editLecturer/{{ $lecturer->id }}" onclick="javascript: return confirm('Are you sure you want to EDIT this record?');">
                ...
                <a href="delete/{{ $lecturer->id }}" onclick="javascript: return confirm('Are you sure you want to DELETE this record?');">
